...
exports.menunya = (salam, pushname, botname) =>{
	return`Hai kak ${pushname} Saya Bot vanzzofc Ada 
Yang Boleh Saya Bantu,bot ini adalah Beta Multi-Device Whatsapp. 
Jika kamu menemukan semacam bug atau kesalahan mohon dimaklumi dulu ya, 
lapor owner agar segera di perbaiki 🙏 
`
}
exports.listMenu = (time, salam, pushname, prefix) => {
    return `*𝙎𝙀𝙇𝘼𝙈𝘼𝙏 𝘿𝙄 𝘽𝙊𝙏 𝙑𝘼𝙉𝙕𝙕𝙊𝙁𝘾 ${pushname}*
*⌚𝙅𝘼𝙈 𝙎𝙀𝙍𝙑𝙀𝙍 : ${time}*
*📚 𝙇𝙄𝙎𝙏 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘽𝙔 𝙑𝘼𝙉𝙕𝙕𝙊𝙁𝘾 :*
...
⚠️ Segala kebijakan dan ketentuan vanzzbotz di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 
...
⚠𝙉𝙊𝙏𝙀 : 𝙏𝙊𝙇𝙊𝙉𝙂 𝙋𝘼𝙏𝙐 𝙃𝙄 𝙍𝙐𝙇𝙀𝙎 𝙔𝘼𝙆`
}
exports.leave = () =>{
	return`𝙎𝙀𝙇𝘼𝙈𝘼𝙏 𝙏𝙄𝙉𝙂𝙂𝘼𝙇 𝙎𝙀𝙈𝙊𝙂𝘼 𝘽𝙀𝙏𝘼𝙃 𝘿𝙄 𝙇𝙐𝘼𝙍 𝙎𝘼𝙉𝘼`
}
exports.source = () =>{
return`*------「 SCRIPT 」 ------*

Base : https://github.com/DikaArdnt/Hisoka-Morou
Recode : https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA
`
}
